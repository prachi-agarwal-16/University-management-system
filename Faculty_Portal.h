...
class Faculty_Portal:public Faculty{
	...
	public:
		...
		void print_Requirements_job()
		{
			...
			cout<<"Bio :- \n\n Name \n  Father Name \n Cnic No \n Phone Nuber \n Address etc"<<endl;
			cout<<"Not attach CV but TCS us main headquater of University "<<endl;
		}
		...
		void apply_JOb()
		{
			...
			cin >>  fatherName;
			cout<<"Enter Adhar Id of person ::- "<<endl;
			cin >> cnic;
